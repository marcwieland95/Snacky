...
class SnacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snack" do
    assert_difference('Snack.count') do
      post snacks_url, params: { snack: { description: @snack.description, image: @snack.image, name: @snack.name, price: @snack.price } }
    end
  ...
  test "should update snack" do
    patch snack_url(@snack), params: { snack: { description: @snack.description, image: @snack.image, name: @snack.name, price: @snack.price } }
